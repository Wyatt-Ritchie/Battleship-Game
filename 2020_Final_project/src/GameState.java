...
//    - Score function (best score saved to .csv)
    ...
    public void LoadHighScore(Label label) throws IOException {
        ...
        // Make sure the String "userPath" is changed depending on the user
        String row = "";
        BufferedReader csvReader = new BufferedReader(new FileReader("/Database/high_scores.csv"));
    ...
    public void InitializeGamePane(Pane pane, Player p1, CPU p2, Stage primaryStage) {
        ...
        CPUBoard.setX(550);
        CPUBoard.setY(40);
        Board boardP2back = new Board();
        boardP2back.displayBoard(pane, 550, 50, p1, p2);
        ...
        if(p1.getLives() == 0) {
            ...
            endGamePane(p1, p1.getScore(), primaryStage);
    ...
    public void DisplayInstructions() throws FileNotFoundException {
        ...
        // Make sure the String "userPath" is changed depending on the user
        File file = new File("/Database/battleship_instructions.txt");
